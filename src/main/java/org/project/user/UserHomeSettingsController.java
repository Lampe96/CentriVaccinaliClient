 ...
 * nella classe {@link UserHomeController}. Gestisce l'eliminazione
 * dell'account tramite il bottone che richiama la classe
 * {@link UserHomeSettingsDeleteController}.
 *
...
public class UserHomeSettingsController implements Initializable {
    ...
    /**
     * Bottone per aprire lo stage dell'{@link UserHomeSettingsDeleteController }.
     */
    @FXML
    ...
    /**
     * Boolean per verificare l'apertura dell'{@link UserHomeSettingsDeleteController }.
     */
     ...
     * controller {@link UserHomeSettingsDeleteController}.
     *
     * @return true se la schermata per eliminare l'account e' stata aperta e
    ...
    /**
     * Viene aperto il pop-up per la delete account.
     *
